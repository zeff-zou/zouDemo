package com.zou.commons.base.util;
...
public class DateTimeUtils extends DateUtils {
    ...
    public static final Date convertMmStringToDateTime(String strMmDateTime) throws ParseException {
        return strMmDateTime==null ? null : new Date((new SimpleDateFormat(DATE_PATTERN + " " + MM_TIME_PATTERN)).parse(strMmDateTime).getTime());
    }

    public static Date convertStringToDateTime(String strDateTime) throws ParseException {
        return strDateTime==null ? null : new Date((new SimpleDateFormat(DATE_PATTERN + " " + TIME_PATTERN)).parse(strDateTime).getTime());
    }
